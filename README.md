...
cities from 2026-05-25 through 2026-06-08. Each event includes the full bracket
set listed on Polymarket. The dashboard has city and date selectors. The
Polymarket chart shows every bracket price line for the selected event, and the
model chart shows generated model probabilities where available. Chart x-axes
are fixed to the selected station's official NWS climate-day window; traces stop
at their latest available timestamp.
